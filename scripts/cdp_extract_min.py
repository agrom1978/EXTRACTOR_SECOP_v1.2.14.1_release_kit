...
def main(
    ...
    default_html = str(Path.home() / "Downloads" / "FireShot" / "Detalle del proceso_ LIC 002-25.html")
    if constancia:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        raise SystemExit(
            "Uso:\n"
            "  python scripts\\cdp_extract_min.py --constancia 25-15-14581710 --template templates\\Plantilla_Salida_EXTRACTOR_SECOP_v1.2.10.xlsx\n"
            "  python scripts\\cdp_extract_min.py --html detalle.html --template templates\\Plantilla_Salida_EXTRACTOR_SECOP_v1.2.10.xlsx\n"
        )
    args = sys.argv[1:]
    constancia = None
    html_path = None
