...
## Extraccion (scripts/secop_extract.py)
...
## Configuracion (scripts/constancia_config.py)
- Regex centralizadas para deteccion y validacion.
- Normalizacion de dashes Unicode.

## Validacion
- tests automatizados en tests/test_cambios.py, tests/test_campos_faltantes.py y tests/test_extraccion_html_completa.py
